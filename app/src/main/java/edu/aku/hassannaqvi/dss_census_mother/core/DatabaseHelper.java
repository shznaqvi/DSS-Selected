package edu.aku.hassannaqvi.dss_census_mother.core;
...
import edu.aku.hassannaqvi.dss_census_mother.contracts.CensusContract.censusMember;
import edu.aku.hassannaqvi.dss_census_mother.contracts.DeceasedContract;
import edu.aku.hassannaqvi.dss_census_mother.contracts.DeceasedContract.DeceasedMember;
import edu.aku.hassannaqvi.dss_census_mother.contracts.FormsContract;
import edu.aku.hassannaqvi.dss_census_mother.contracts.FormsContract.FormsTable;
import edu.aku.hassannaqvi.dss_census_mother.contracts.HouseholdContract;
import edu.aku.hassannaqvi.dss_census_mother.contracts.HouseholdContract.householdForm;
import edu.aku.hassannaqvi.dss_census_mother.contracts.MembersContract;
import edu.aku.hassannaqvi.dss_census_mother.contracts.MembersContract.singleMember;
import edu.aku.hassannaqvi.dss_census_mother.contracts.MotherContract;
import edu.aku.hassannaqvi.dss_census_mother.contracts.MotherContract.MotherTB;
import edu.aku.hassannaqvi.dss_census_mother.contracts.SectionKIMContract;
import edu.aku.hassannaqvi.dss_census_mother.contracts.UsersContract;
import edu.aku.hassannaqvi.dss_census_mother.contracts.UsersContract.singleUser;
import edu.aku.hassannaqvi.dss_census_mother.otherClasses.MothersLst;

import static edu.aku.hassannaqvi.dss_census_mother.contracts.SectionKIMContract.singleIm;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DB_NAME = "dss-census_mother_copy.db";
...
//            singleMember.COLUMN_CHILD_DOB + " TEXT" +
    ...
    /*private static final String SQL_CREATE_DECEASED = "CREATE TABLE "
            ...
            DeceasedMember.COLUMN_SM + " TEXT," +
            DeceasedMember.COLUMN_CHILD_DOB + " TEXT," +
...
//                singleIm.COLUMN_CHILDID,
    ...
    public Collection<MotherContract> getTodayForms() {
        ...
        Collection<MotherContract> allMC = new ArrayList<>();
        try {
            c = db.rawQuery("select * from mother where formdate Like ? ", new String[]{"%" + spDateT.substring(0, 8).trim() + "%"});

            while (c.moveToNext()) {
                MotherContract mc = new MotherContract();
                mc.set_ID(c.getString(c.getColumnIndex(MotherTB.COLUMN_ID)));
                mc.setDssID(c.getString(c.getColumnIndex(MotherTB.COLUMN_DSSID)));
                mc.setFormDate(c.getString(c.getColumnIndex(MotherTB.COLUMN_FORMDATE)));
                mc.setIstatus(c.getString(c.getColumnIndex(MotherTB.COLUMN_ISTATUS)));
                allMC.add(mc);
            }
        } finally {
            if (c != null) {
